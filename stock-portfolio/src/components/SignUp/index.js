  ...
  return (
    ...
    <>
      ...
      <div class="text-center mx-auto w-50">
        ...
        <label for="inputFirstName" class="sr-only mt-3">
          First Name
        </label>
        <input
          type="firstName"
        ...
        <label for="inputLastName" class="sr-only mt-3">
          Last Name
        </label>
        <input
          type="lastName"
        ...
        <div class="d-flex justify-content-center">
          <label for="inputEmail" class="sr-only mt-3">
            Email
          </label>
          <EmailRuleModal />
        </div>
        <input
          ...
          id="email"
          class="form-control"
          placeholder="michal.jackson@gmail.com"
          required
          autofocus
          onChange={(evt) => setEmail(evt.target.value)}
        />
        {isEmailError && <p class="text-danger">Please check Email Rule!</p>}

        <label for="inputUserName" class="sr-only mt-3">
          User Name
        </label>
        <input
          type="userName"
        ...
        <div class="d-flex justify-content-center">
          <label for="inputPassword" class="sr-only mt-3">
            Password
          </label>
          <PasswordRuleModal />
        </div>
